...
class GenerationPromptComposerTest {
    ...
    private static GenerationMaterial materialWith(StoreMaterial store) {
    ...
    class StoreSection {
        ...
        void carriesEveryField_whenStoreFullyWritten() {
            String prompt = composer.compose(materialWith(new StoreMaterial("보니스커피", "카페", "서울 중구 을지로 100",
        ...
        void omitsBusinessHours_whenOnlyOpenTimeWritten() {
            String prompt = composer.compose(materialWith(new StoreMaterial("보니스커피", null, null, null,
        ...
        void carriesOperationLines_whenOnlyOperationInfoWritten() {
            String prompt = composer.compose(materialWith(new StoreMaterial(null, null, null, null,
        ...
        void omitsNameLine_whenNameBlank() {
            String prompt = composer.compose(materialWith(new StoreMaterial("   ", "카페", null, null,
