...
@Schema(description = "채널별 콘텐츠 편집 요청")
public record ContentChannelEditRequest(
    ...
    public ContentChannelEditCommand toCommand(Long memberId, Long contentId, Long contentChannelId) {
        return new ContentChannelEditCommand(memberId, contentId, contentChannelId, title, body, hashtags);
    }
}
