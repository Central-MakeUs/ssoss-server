...
public record TemplateListCommand(Long memberId, TemplateCategory category, int page, int size) {

    public static TemplateListCommand of(Long memberId, String category, int page, int size) {
